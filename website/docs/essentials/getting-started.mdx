...
```javascript
import { all, model } from 'func-model/core';
...
```javascript
import { find, oneOrFail } from 'func-model/core';
import Post from './models/post';
import action from './action';
...
```javascript
import { create, raw, fill } from 'func-model/core';
import Post from './models/post';
import action from './action';
...
```javascript
import { instance, knownData } from 'func-model/core';
