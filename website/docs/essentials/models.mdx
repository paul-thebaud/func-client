...
:::info
FuncModel also propose multiple utilities to work with models:
...
:::caution
You must not use `id`, `type` or `exists` as key of any
...
:::caution
Note that FuncModel consider your attributes as non-nullable values by default.
...
:::caution
Note that FuncModel consider your relations as non-nullable values by default.
