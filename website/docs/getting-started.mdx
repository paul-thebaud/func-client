...
- The model `definition`, which contains your attributes/relations definitions and custom properties
and methods.
...
you can directly use the `makeModel` returned value instead of extending it:
...
You can use this model as any Javascript classes:

- Construct a new instance using `new`
- Accessing instance's properties
