...
- [`{I extends ModelInstance}`](/docs/api/types#modelinstanced) `instance`
- [`{Partial<ModelValues<I>>}`](/docs/api/types#modelvaluesm) `values`
...
- [`{I extends ModelInstance}`](/docs/api/types#modelinstanced) `instance`
- [`{Arrayable<ModelKey<I>> | undefined}`](/docs/api/types#modelkeym) `keys`
...
- [`{I extends ModelInstance}`](/docs/api/types#modelinstanced) `instance`
- [`{Arrayable<ModelRelationDotKey<I>>}`](/docs/api/types#modelrelationdotkeym) `relations`
...
- [`{ModelConfig | string}`](/docs/api/types#modelconfig) `config`
- [`{ModelDefinition}`](/docs/api/types#modeldefinition) `extendsFrom`

#### Returns

[`{ModelClass}`](/docs/api/types#modelclass)
...
- [`{ModelDefinition | undefined}`](/docs/api/types#modeldefinition) `baseExtendsFrom`
- [`{ModelConfig | undefined}`](/docs/api/types#modelconfig) `baseConfig` (omitting `type`)
