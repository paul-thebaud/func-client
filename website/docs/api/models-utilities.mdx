...
- [`{I extends ModelInstance}`](/docs/api/func-client/modules/core#modelinstance) `instance`
- [`{Arrayable<ModelKey<I>> | undefined}`](/docs/api/func-client/modules/core#modelkey) `keys`
...
- [`{I extends ModelInstance}`](/docs/api/func-client/modules/core#modelinstance) `instance`
- [`{Arrayable<ModelRelationDotKey<I>>}`](/docs/api/func-client/modules/core#modelrelationdotkey) `relations`
...
- [`{ModelDefinition}`](/docs/api/func-client/modules/core#modeldefinition) `extendsFrom`
...
- [`{ModelDefinition | undefined}`](/docs/api/func-client/modules/core#modeldefinition) `baseExtendsFrom`
